...
<li><strong>評估與醫療：</strong>兒童體能智力測驗服務、兒科／專科跟進、復康治療（例如職業治療、物理治療、言語治療）。</li>
<li><strong>社福與社區：</strong>社會福利署及非政府機構的康復、日間訓練、家長資源中心等服務。</li>
...
<li>利用水的浮力減輕負重，先練習平衡與水感，再談划水效率。</li>
<li>動作可改寫成「單側主導」或「軀幹帶動」版本，目標是安全前進與自信心，而非刻板模仿標準泳姿。</li>
<li>注意皮膚、支架接觸面與長時間浸水的舒適度；課後更換乾燥衣物。</li>
</ul>
<h2>視覺障礙：空間與提示</h2>
<ul>
<li>先以口語描述泳池環境（池邊、水深、扶梯位置），讓孩子建立心智地圖。</li>
<li>固定出發點與休息位置；轉身或到邊時可用聲音或輕觸提示（正式賽事中的 Tapper 概念，在教學中以溫和、預告式提示代替）。</li>
<li>避免突然從背後觸碰；先說明「我現在會扶你的手肘」。</li>
<li>弱視孩子可配合高對比浮具與清晰的邊界標記。</li>
</ul>
<h2>聽力障礙：看得見的指令</h2>
<ul>
<li>教練面向孩子、光線充足時示範；重要指令配合手勢或圖卡。</li>
<li>下水前先講解本節目標；水中盡量減少長句，改為短促、可重複的訊號。</li>
<li>若使用助聽器／人工耳蝸，請家長說明是否可於水中配戴防水配件；否則以視覺溝通為主。</li>
...
<li><strong>短時多次：</strong>20–30 分鐘高品質練習，往往比過長課堂更有效。</li>
...
<h2>多重障礙時的優先次序</h2>
<p>當孩子同時有多種需要，我們會先處理<strong>安全與溝通</strong>，再談泳姿。例如：先能安心浸水與求助，才練習划手；若伴隨感官過敏，先降刺激再增加動作難度。家長與學校／復康團隊的資訊，有助我們避免互相矛盾的目標。</p>
<h2>與競技路徑的關係</h2>
